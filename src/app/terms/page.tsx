  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose text-charcoal/70 space-y-4">
        ...
        <p>Product reviews and recommendations are based on independent research into materials, repairability, warranties, manufacturer documentation, and long-term owner reports. Hands-on testing is identified only when it actually occurred. We strive for accuracy but make no guarantees about product availability, pricing, or performance.</p>
        ...
        <p>All content on this site, including text, images, and design, is the property of Everlasting Goods unless otherwise noted. Product images may be sourced from Wikimedia Commons under their respective licenses.</p>
        <h2 className="font-serif text-xl font-bold text-charcoal mt-6">Limitation of Liability</h2>
        <p>Everlasting Goods shall not be liable for any damages arising from the use of this website or reliance on our product recommendations.</p>
      </div>
    </main>
  );
}
