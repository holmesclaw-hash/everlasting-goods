...
import { restoredGuideCount } from "@/content/restored-guides";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="border-t border-cream-200 bg-cream-100"><div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:flex lg:items-center lg:justify-between lg:gap-10 lg:px-8"><div><p className="text-sm font-semibold uppercase tracking-wider text-brown-accent">Evidence-reviewed guides</p><h2 className="mt-2 font-serif text-3xl font-bold text-charcoal">{restoredGuideCount} restored guides are ready to read.</h2><p className="mt-3 max-w-2xl text-sm leading-relaxed text-charcoal/60">Browse only the guides that passed claim, product-identity, exact-photo rights, and destination checks. Quarantined legacy articles remain excluded.</p></div><Link href="/blog" className="mt-6 inline-block shrink-0 rounded-xl bg-forest-500 px-5 py-3 font-semibold text-white hover:bg-forest-600 lg:mt-0">Browse verified guides →</Link></div></section>
    </>
  );
}
